...
Conclusion
The fine-tuned YOLOv8m model achieved the best performance in traffic sign detection with mAP50-95 of 0.85369. Image size and learning rate are important hyperparameters that can be tuned further to optimize the balance between accuracy and inference speed for specific deployment scenarios.
